...
namespace QUANLYQUANNET
{
    public partial class NhanVien : Form
    {
        ...
        void loadnhanvien()
        {
            ...
            cmd.CommandText = "select MANV as [Mã Nhân Viên], HO +' '+TEN as [Tên], GIOITINH as [Giới tính],format(NGAYSINH,'dd/MM/yyyy') as [Ngày sinh], DIACHI as [Địa chỉ], DIENTHOAI as [Số điện thoại],CMND, LUONGCOBAN AS [Lương cơ bản], TENCV as [Chức vụ], TENKHU as [Khu] from NHANVIEN nv join CHUCVU cv on nv.MACV=cv.MACV join KHU k on k.MAKHU=nv.MAKHU ";
        ...
        private void dgvnhanvien_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (i < dgvnhanvien.Rows.Count - 1)
            {
                ...
                cbbkhu.Text = dgvnhanvien.Rows[i].Cells[9].Value.ToString();
            }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            cmd = con.CreateCommand();
            cmd.CommandText = "select MAKHU from KHU WHERE TENKHU=N'" + cbbkhu.Text + "'";
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
                if (reader.Read())
                {
                    khu = reader["MAKHU"].ToString();
            ...
            /* if (cbbkhu.Text == "01")
                 ...
                 khu = "K03";*/
            cmd = con.CreateCommand();
            cmd.CommandText = "insert into NHANVIEN values('" + txtmanv.Text + "',N'" + firstWords + "',N'" + lastWord + "','" + txtgioitinh.Text + "','" + ngaysinh_sql + "','" + txtdiachi.Text + "','" + txtsdt.Text + "','" + txtcmnd.Text + "','" + txtluong.Text + "','" + chucvu + "','" + khu + "')";
            cmd.ExecuteNonQuery();
            loadnhanvien();
        }
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            cmd = con.CreateCommand();
            cmd.CommandText = "UPDATE NHANVIEN SET HO = N'" + firstWords + "', TEN = N'" + lastWord + "', GIOITINH = '" + txtgioitinh.Text + "', NGAYSINH = '" + ngaysinh_sql + "', DIACHI = '" + txtdiachi.Text + "', DIENTHOAI = '" + txtsdt.Text + "', CMND = '" + txtcmnd.Text + "', LUONGCOBAN = '" + txtluong.Text + "', MACV = '" + chucvu + "', MAKHU = '" + khu + "' WHERE MANV = '" + txtmanv.Text + "'";
            cmd.ExecuteNonQuery();
            loadnhanvien();
