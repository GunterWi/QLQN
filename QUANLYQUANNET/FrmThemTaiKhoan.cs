    ...
    public partial class FrmThemTaiKhoan : Form
    {
        ...
        private void btncapnhap_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "insert into THANHVIEN values ('" + txttk.Text + "','" + txtmk.Text + "','" + sotienbandau.ToString() + "',@ngaylap,@ngayhethan,'Hoi vien')";
        ...
        private void txtsotien_TextChanged(object sender, EventArgs e)
        {
            ...
            sotienbandau = tongtien / 60 * 8000; //chuyển về lại số tiền ban đầu
            int digits = -3;
            sotienbandau = Math.Round(sotienbandau / Math.Pow(10, -digits)) * Math.Pow(10, -digits);
